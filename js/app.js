...
// Create Post Modal (aliases)
app.openCreateModal = function() {
    if (typeof app.showCreateModal === 'function') {
        app.showCreateModal();
    } else {
        app.toast('Post creator not ready', 'error');
    }
};

app.openPostModal = app.openCreateModal;
